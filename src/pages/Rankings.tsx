            ...
            <Tabs defaultValue="rounds" className="w-full">
              ...
              <TabsList className="bg-[hsl(var(--gg-surface-light))] border border-[hsl(var(--gg-navy-deep))]/12 p-1 h-auto rounded-sm">
                ...
                <Link
                  ...
                  className="text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-[hsl(var(--gg-green))] hover:text-[hsl(var(--gg-navy-deep))] transition-colors border-b border-[hsl(var(--gg-green))]/30 hover:border-[hsl(var(--gg-navy-deep))]/50 pb-0.5 self-start sm:self-auto"
                >
